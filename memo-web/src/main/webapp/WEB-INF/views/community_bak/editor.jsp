...
<script src="<%=path%>/static/js/community/forum.js" type="text/javascript"></script>
</head>
<body id="nv_forum" class="vr_bbs pg_post" onkeydown="if(event.keyCode==27) return false;">
	...
	<div id="wp" class="wp">
        ...
        <script src="<%=path%>/static/js/community/forum_post.js" type="text/javascript"></script>
		<div id="pt" class="bm cl">
			<div class="z">
				<a href="" class="nvhm" title="首页">Danica World</a> <em>&rsaquo;</em>
				<a href="forum/index">作品</a> <em>&rsaquo;</em>
				发表帖子
			</div>
		</div>
		<form method="post" autocomplete="off" id="postform" onsubmit="return validate(this)">
			<div id="ct" class="ct2_a ct2_a_r wp cl">
				...
				<input type="hidden" name="posttime" id="posttime" value="1462781468" />
				<input type="hidden" name="wysiwyg" id="e_mode" value="1" />
				<div class="bm bw0 cl" id="editorbox">
					<ul class="tb cl mbw">
						<li class="a">
						    <a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=newthread')">发表帖子</a>
					    </li>
						<li>
						    <a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=newthread&special=1')">发起投票</a>
						</li>
					</ul>
					...
					<div id="postbox">
						<div class="pbt cl">
							<div class="z">
								<span>
									...
									tabindex="1" /></span> <span id="subjectchk">还可输入 <strong
						...
						<div id="attachnotice_attach" class="tbms mbm xl"
							style="display: none">
							您有 <span id="unusednum_attach"></span> 个未使用的附件 &nbsp; 
							<a href="javascript:;" class="xi2" onclick="attachoption('attach', 2);" />查看</a>
							<span class="pipe">|</span>
							<a href="javascript:;" class="xi2" onclick="attachoption('attach', 1)">使用</a>
							<span class="pipe">|</span>
							<a href="javascript:;" class="xi2" onclick="attachoption('attach', 0)">删除</a>
							<div id="unusedlist_attach" style="display: none"></div>
						</div>
						<div id="attachnotice_img" class="tbms mbm xl" style="display: none">
							您有 <span id="unusednum_img"></span> 个未使用的图片 &nbsp; 
							<a href="javascript:;" class="xi2" onclick="attachoption('img', 2);" />查看</a>
							<span class="pipe">|</span>
							<a href="javascript:;" class="xi2" onclick="attachoption('img', 1)">使用</a>
							<span class="pipe">|</span>
							<a href="javascript:;" class="xi2" onclick="attachoption('img', 0)">删除</a>
							<div id="unusedlist_img" style="display: none"></div>
						</div>
						<div id="e_body_loading">
							<img src="<%=path%>/static/css/community/images/loading.gif" width="16" height="16" class="vm" /> 请稍后 ...
						</div>
						<div class="edt" id="e_body" style="display: none">
							<div id="e_controls" class="bar">
								...
								<div id="e_button" class="btn cl">
									<div class="b2r nbr nbl" id="e_adv_s2">
										<a id="e_fontname" class="dp" title="设置字体" menupos="43!">
										    <span id="e_font">字体</span>
										</a> 
										<a id="e_fontsize" class="dp" title="设置文字大小" menupos="43!" menuwidth="25">
										    <span id="e_size">大小</span>
										</a> 
										<span id="e_adv_1"> 
										    <a id="e_inserthorizontalrule" title="分隔线">Hr</a> <br />
										</span> 
										...
										<span id="e_adv_8">d<a id="e_unlink" title="移除链接">Unlink</a></span>
									</div>
									...
									<div class="b2r esb" id="e_adv_s3">
										...
										<a id="e_code" title="添加代码文字">代码</a> 
										<a id="e_free" adv="1" title="添加免费信息">Free</a>
										<a id="e_pasteword" adv="1" title="从 Word 粘贴内容">Word 粘贴</a> 
										<a id="e_page" adv="1" title="分页">Page</a> 
										<a id="e_index" adv="1" title="目录">Index</a> 
										<a id="e_password" adv="1" title="帖子密码">Password</a> 
										<a id="e_postbg" adv="1" title="帖子背景">Background</a> 
										<a id="e_cst1_qq" class="cst" title="显示 QQ 在线状态，点这个图标可以和他（她）聊天">
										    <img src="<%=path%>/static/css/community/images/bb_qq.gif"
							...
							<div id="rstnotice" class="ntc_l bbs" style="display: none">
								<a href="javascript:;" title="清除内容" class="d y"
									onclick="userdataoption(0)">close</a>您有上次未提交成功的数据 
							...
							<link rel="stylesheet" type="text/css" href='<%=path%>/static/css/community/style_2_editor.css' />
							<script src="<%=path%>/static/js/community/editor.js" type="text/javascript"></script>
							<script src="<%=path%>/static/js/community/bbcode.js" type="text/javascript"></script>
							<!-- <script src="<%=path%>/static/js/community/common_postimg.js" type="text/javascript"></script> -->
							<script type="text/javascript">
								var editorid = 'e';
							...
							<div id="e_bbar" class="bbar">
								...
								<a href="javascript:;" onclick="discuzcode('svd');return false;"
									id="e_svd">保存数据</a> | 
								...
								<span id="e_resize">
								    ...
								    <img src="<%=path%>/static/css/community/images/editor/resize.gif" onmousedown="editorresize(event)" />
								</span>
							</div>
						</div>
								...
								<div class="exfm cl" id="extra_additional_c" style="display: none;">
									<table cellspacing="0" cellpadding="0">
										<tr>
											...
											<td>
											    <label for="hiddenreplies">
											        <input type="checkbox" name="hiddenreplies" id="hiddenreplies"
													class="pc" value="1">回帖仅作者可见</label> 
												<label for="ordertype">
												    <input type="checkbox" name="ordertype" id="ordertype" class="pc"
													value="1" />回帖倒序排列</label> 
												<label for="allownoticeauthor">
												    <input type="checkbox" name="allownoticeauthor"
													id="allownoticeauthor" class="pc" value="1"
													checked="checked" />接收回复通知</label> 
												<label for="usesig">
												    <input type="checkbox" name="usesig" id="usesig" class="pc"
										...
										<tr>
											...
											<td>
											    <label for="htmlon">
											        <input type="checkbox" name="htmlon" id="htmlon" class="pc" value="0"
													disabled="disabled" />HTML 代码</label> 
												<label for="allowimgcode">
												    <input type="checkbox" id="allowimgcode" class="pc"
													disabled="disabled" checked="checked" />[img] 代码</label> 
												<label for="allowimgurl">
												    <input type="checkbox" id="allowimgurl" class="pc" checked="checked" />解析图片链接</label> 
												<label for="parseurloff">
												    <input type="checkbox" name="parseurloff" id="parseurloff" class="pc" value="1" />禁用链接识别</label>
												<label for="smileyoff">
												    <input type="checkbox" name="smileyoff" id="smileyoff" class="pc" value="1" />禁用表情</label>
												<label for="bbcodeoff">
												    <input type="checkbox" name="bbcodeoff" id="bbcodeoff" class="pc" value="1" />禁用编辑器代码</label>
												<label for="imgcontent">
												    <input type="checkbox" name="imgcontent" id="imgcontent" class="pc" value="0"
													disabled="disabled" />内容生成图片</label>
											</td>
										</tr>
									</table>
								</div>
						...
						<div class="mtm mbm pnpost">
							...
							<button type="button" id="postsubmit" class="pn" value="true" onclick="$('postsave').value = 1;$('postsubmit').click();">
								<em>保存草稿</em>
							</button>
						</div>
					</div>
									...
									<div class="p_opt">
										<table cellpadding="0" cellspacing="0" border="0" width="100%">
											<tbody id="imgattachbodyhidden" style="display: none">
												<tr>
													<td class="atnu"><span id="imglocalno[]">
													    <img src="<%=path%>/static/css/community/images/editor/common_new.gif" /></span></td>
													<td class="atna">
													    <span id="imgdeschidden[]" style="display: none"> 
													        <span id="imglocalfile[]"></span>
													    </span> 
													    <input type="hidden" name="imglocalid[]" /></td>
										...
										<div class="upbk pbm bbda">
											<div id="imgattachbtnhidden" style="display: none">
												<span>
												    <form name="imgattachform" id="imgattachform"
														method="post" autocomplete="off"
														action="misc.php?mod=swfupload&amp;operation=upload&amp;simple=1&amp;type=image"
														target="attachframe" enctype="multipart/form-data">
														<input type="hidden" name="uid" value="308">
														<input type="hidden" name="hash" value="bdfc3fdd8827c90231f460482bc9587e">
											...
											<p id="imguploadbtn">
												<button class="pn pnc vm" type="button" onclick="uploadAttach(0, 0, 'img')">
													<span>上传</span>
												</button>
												<span class="xg1">&larr;选择完文件后请点击“上传”按钮</span>
											</p>
											<p id="imguploading" style="display: none;">
												<img src="<%=path%>/static/css/community/images/editor/uploading.gif"
													style="vertical-align: middle;" /> 上传中，请稍候，您可以
										...
										<tbody id="attachbodyhidden" style="display: none">
											<tr>
												<td class="atnu"><span id="localno[]"><img
														src="<%=path%>/static/css/community/images/editor/common_new.gif" /></span></td>
		...
		<script src="<%=path%>/static/js/community/upload.js" type="text/javascript"></script>
		<script type="text/javascript">
