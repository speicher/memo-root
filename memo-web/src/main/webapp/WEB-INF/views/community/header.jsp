...
<script src="<%=path%>/static/assets/js/libs/jquery.min.js" type="text/javascript"></script>
<script src="<%=path%>/static/assets/js/libs/jquery.extend.min.js" type="text/javascript"></script>
